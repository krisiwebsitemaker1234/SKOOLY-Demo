...
if ($selected_child_id) {
    ...
    if ($selected_child) {
        $stmt = $conn->prepare("SELECT * FROM attendance WHERE student_id = ? ORDER BY attendance_date DESC LIMIT 50");
    ...
    <div class="body-wrapper">
      ...
      <div class="body-wrapper-inner">
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title mb-4"><?php echo $selected_child['first_name']; ?>'s Attendance Records</h4>
              <?php if (empty($child_attendance)): ?>
              <div class="text-center py-5"><i class="ti ti-calendar-x fs-1 text-muted"></i><p class="text-muted mt-2">No attendance records</p></div>
              <?php else: ?>
              <div class="table-responsive">
                <table class="table table-hover align-middle">
                  ...
                  <tbody>
                    <?php foreach ($child_attendance as $r): ?>
                    <tr>
                      <td><strong><?php echo format_date($r['attendance_date']); ?></strong></td>
